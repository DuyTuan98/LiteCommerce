...
namespace LiteCommerce.DataLayers.SqlServer
{
    public class EmployeeDAL : IEmployeeDAL
    {
        ...
        public Employee GetByEmail(string email, int exceptID = 0)
        {
            Employee data = null;
            using (SqlConnection connection = new SqlConnection(connectionString))
            {
                ...
                {
                    cmd.CommandText = @"SELECT * FROM Employees WHERE Email = @Email AND EmployeeID != @EmployeeID";
                }
                ...
                {
                    cmd.Parameters.AddWithValue("@EmployeeID", exceptID);
                }
